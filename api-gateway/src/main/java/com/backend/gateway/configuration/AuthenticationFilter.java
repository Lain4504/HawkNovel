...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private final String[] publicEndpoints = {
            ...
            "/profile/users/.*",
            "/post/posts/get/.*",
            "/post/post-categories/get/.*",
            "/notification/notifications/.*",
            "/comment/post-comments/get/.*",
            "/comment/novel-chapter-comments/get/.*",
            "/comment/novel-comments/get/.*",
            "/comment/novel-comments/replies/get/.*",
            ...
            "/profile/user-novel-follow/get/.*",
            "/profile/user-novel-review/get/.*",
    };
